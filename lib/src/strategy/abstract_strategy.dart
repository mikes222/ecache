...
abstract class AbstractStrategy<K, V> {
  ...
  /// Hook called after a key has been removed from the cache.
  ///
  /// Strategies that maintain additional metadata (e.g. LRU/LFU bookkeeping)
  /// should override this to keep internal state in sync.
  void onRemove(K key) {}

  /// Hook called after the cache has been cleared.
  ///
  /// Strategies that maintain additional metadata (e.g. LRU/LFU bookkeeping)
  /// should override this to keep internal state in sync.
  void onClear() {}

  /// Hook called before cache disposal.
  ///
  /// Strategies that maintain additional metadata should override this to free
  /// references.
  void onDispose() {}
}
